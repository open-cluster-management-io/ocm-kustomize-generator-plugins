...
PlacementBinding, either specify `placement.placementPath` to an existing Placement manifest or set
...
`placement.placementRulePath` or specifying labels in `placement.ClusterSelectors`.
